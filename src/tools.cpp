...
/**
* Parse dinastycoin address in a string form into
...
/**
* Return string representation of dinastycoin address
*/
string
...
{
    // default path to dinastycoin folder
    // on linux this is /home/<username>/.bitdinastycoin
    string default_dinastycoin_dir = tools::get_default_data_dir();

    if (nettype == cryptonote::network_type::TESTNET)
        default_dinastycoin_dir += "/testnet";
    if (nettype == cryptonote::network_type::STAGENET)
        default_dinastycoin_dir += "/stagenet";


    // the default folder of the lmdb blockchain database
    // is therefore as follows
    return default_dinastycoin_dir + string("/lmdb");
}

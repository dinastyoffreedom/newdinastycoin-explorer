...
main(int ac, const char* av[])
{
    ...
    // set  dinastycoin log output level
    ...
    if (testnet && deamon_url == "http:://127.0.0.1:37176")
        deamon_url = "http:://127.0.0.1:28081";
    if (stagenet && deamon_url == "http:://127.0.0.1:37176")
    ...
    CROW_ROUTE(app, "/")
    ([&]() {
        return myxmr::htmlresponse(dcyblocks.index2());
    });

    CROW_ROUTE(app, "/page/<uint>")
    ([&](size_t page_no) {
        return myxmr::htmlresponse(dcyblocks.index2(page_no));
    });

    CROW_ROUTE(app, "/block/<uint>")
    ([&](size_t block_height) {
        return myxmr::htmlresponse(dcyblocks.show_block(block_height));
    });
    
    CROW_ROUTE(app, "/randomx/<uint>")
    ([&](size_t block_height) {
        return myxmr::htmlresponse(dcyblocks.show_randomx(block_height));
    });

    CROW_ROUTE(app, "/block/<string>")
    ([&](string block_hash) {
        return myxmr::htmlresponse(
                dcyblocks.show_block(remove_bad_chars(block_hash)));
    });

    CROW_ROUTE(app, "/tx/<string>")
    ([&](string tx_hash) {
        return myxmr::htmlresponse(
                dcyblocks.show_tx(remove_bad_chars(tx_hash)));
    });
    if (enable_autorefresh_option)
    {
        ...
        ([&](string tx_hash) {
            ...
            return myxmr::htmlresponse(
                dcyblocks.show_tx(remove_bad_chars(tx_hash), with_ring_signatures, refresh_page));
        });
    }
    ...
    if (enable_as_hex)
    {
        ...
        ([&](string tx_hash) {
            return crow::response(
                    dcyblocks.show_tx_hex(remove_bad_chars(tx_hash)));
        });

        CROW_ROUTE(app, "/ringmembershex/<string>")
        ([&](string tx_hash) {
            return crow::response(
                    dcyblocks.show_ringmembers_hex(remove_bad_chars(tx_hash)));
        });

        CROW_ROUTE(app, "/blockhex/<uint>")
        ([&](size_t block_height) {
            return crow::response(
                    dcyblocks.show_block_hex(block_height, false));
        });

        CROW_ROUTE(app, "/blockhexcomplete/<uint>")
        ([&](size_t block_height) {
            return crow::response(
                    dcyblocks.show_block_hex(block_height, true));
        });

//        CROW_ROUTE(app, "/ringmemberstxhex/<string>")
//        ([&](string tx_hash) {
//            return crow::response(
//              dcyblocks.show_ringmemberstx_hex(remove_bad_chars(tx_hash)));
//        });

        CROW_ROUTE(app, "/ringmemberstxhex/<string>")
        ([&](string tx_hash) {
            return myxmr::jsonresponse {
                dcyblocks.show_ringmemberstx_jsonhex(
    ...
    if (enable_autorefresh_option)
    {
        ...
        ([&](string tx_hash, uint16_t with_ring_signature) {
            bool refresh_page {true};
            return myxmr::htmlresponse(
                dcyblocks.show_tx(remove_bad_chars(tx_hash), with_ring_signature, refresh_page));
        });
    }
    ...
    ([&](const crow::request& req) -> myxmr::htmlresponse
     {
        ...
        {
            return string("dcy address, viewkey or tx hash not provided");
        }
        ...
        string response = dcyblocks.show_my_outputs(
                                         tx_hash, xmr_address,
                                         viewkey, raw_tx_data,
                                         domain);
    ...
    ([&](const crow::request& req, string tx_hash,
        string xmr_address, string viewkey)
     {
        ...
        return myxmr::htmlresponse(dcyblocks.show_my_outputs(
                                         remove_bad_chars(tx_hash),
        ...
        ([&](const crow::request& req) -> myxmr::htmlresponse 
         {
            ...
            {
                return string("dcy address, tx private key or "
            ...
            return myxmr::htmlresponse(dcyblocks.show_prove(tx_hash,
                                        xmr_address,
                                        tx_prv_key,
                                        raw_tx_data,
                                        domain));
    ...
    ([&](const crow::request& req, string tx_hash,
         string xmr_address, string tx_prv_key) 
     {
        ...
        return myxmr::htmlresponse(dcyblocks.show_prove(
                                    remove_bad_chars(tx_hash),
                                    remove_bad_chars(xmr_address),
    ...
    if (enable_pusher)
    {
        ...
        ([&]() {
            return myxmr::htmlresponse(dcyblocks.show_rawtx());
        });
        ...
        ([&](const crow::request& req) -> myxmr::htmlresponse
         {
            ...
            if (action == "check")
                return myxmr::htmlresponse(
                        dcyblocks.show_checkrawtx(raw_tx_data, action));
            else if (action == "push")
                return myxmr::htmlresponse(
                        dcyblocks.show_pushrawtx(raw_tx_data, action));
    ...
    if (enable_key_image_checker)
    {
        ...
        ([&]() {
            return myxmr::htmlresponse(dcyblocks.show_rawkeyimgs());
        });
        ...
        ([&](const crow::request& req) -> myxmr::htmlresponse
         {
            ...
            return myxmr::htmlresponse(
                    dcyblocks.show_checkrawkeyimgs(raw_data, viewkey));
        });
    }
    ...
    if (enable_output_key_checker)
    {
        ...
        ([&]() {
            return myxmr::htmlresponse(dcyblocks.show_rawoutputkeys());
        });
        ...
        ([&](const crow::request& req) -> myxmr::htmlresponse
         {
            ...
            return myxmr::htmlresponse(
                    dcyblocks.show_checkcheckrawoutput(raw_data, viewkey));
        });
    }
    ...
    ([&]() {
        return myxmr::htmlresponse(dcyblocks.mempool(true));
    });
...
//    });
    ...
    if (enable_json_api)
    {
        ...
        ([&](string tx_hash) {
            ...
            myxmr::jsonresponse r{dcyblocks.json_transaction(remove_bad_chars(tx_hash))};
        ...
        ([&](string tx_hash) {
            ...
            myxmr::jsonresponse r{dcyblocks.json_rawtransaction(remove_bad_chars(tx_hash))};
        ...
        ([&](string tx_hash) {
            ...
            myxmr::jsonresponse r{dcyblocks.json_detailedtransaction(remove_bad_chars(tx_hash))};
        ...
        ([&](string block_no_or_hash) {
            ...
            myxmr::jsonresponse r{dcyblocks.json_block(remove_bad_chars(block_no_or_hash))};
        ...
        ([&](string block_no_or_hash) {
            ...
            myxmr::jsonresponse r{dcyblocks.json_rawblock(remove_bad_chars(block_no_or_hash))};
        ...
        ([&](const crow::request &req) {
            ...
            myxmr::jsonresponse r{dcyblocks.json_transactions(
        ...
        ([&](const crow::request &req) {
            ...
            myxmr::jsonresponse r{dcyblocks.json_mempool(
                    remove_bad_chars(page), remove_bad_chars(limit))};
        ...
        ([&](string search_value) {
            ...
            myxmr::jsonresponse r{dcyblocks.json_search(remove_bad_chars(search_value))};
        ...
        ([&]() {
            ...
            myxmr::jsonresponse r{dcyblocks.json_networkinfo()};
        ...
        ([&]() {
            ...
            myxmr::jsonresponse r{dcyblocks.json_emission()};
        ...
        ([&](const crow::request &req) {
            ...
            myxmr::jsonresponse r{dcyblocks.json_outputs(
                    remove_bad_chars(tx_hash),
        ...
        ([&](const crow::request &req) {
            ...
            myxmr::jsonresponse r{dcyblocks.json_outputsblocks(
        ...
        ([&]() {
            ...
            myxmr::jsonresponse r{dcyblocks.json_version()};
    ...
    if (enable_autorefresh_option)
    {
        ...
        ([&]() {
            uint64_t page_no {0};
            bool refresh_page {true};
            return dcyblocks.index2(page_no, refresh_page);
        });
    }
